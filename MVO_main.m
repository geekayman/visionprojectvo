...
INDEX = '02';
imagedir = ['C:\Users\ayman\Desktop\fff'];
images = imageDatastore(imagedir);

% Read the first 1000 images from each datastream
number = min(51, size(images.Files,1));
...
K = [2953.0459 0.000000000000e+00 1998.7122 ;...
     0.000000000000e+00 2959.0112 1513.1037  ;...
...
gtdir = ['C:\Users\ayman\Desktop\00.txt'];
data = load(gtdir);
...
latestFrame=rgb2gray(latestFrame);
